...
def get_list_of_dead_assets(response):
    ...
    # # Calculate the threshold time (5 days ago)
    threshold_time = current_time - timedelta(days=5)

    # # Initialize a count for instances more than 5 days old
    count_old_instances = 0

    # Initialize a list to store the host IDs of instances more than 2 days old
    old_instance_ids = []

    # # Iterate through instances to count those more than 5 days old
...
if response is not None:
    ...
    delete_assets(main_headers, host_ids)
else:
